...
testingImageDir = '../data/icvl/Depth/test_icvl/'
...
class my_dataloader(torch.utils.data.Dataset):
    ...
    def __init__(self, trainingImageDir, center, lefttop_pixel, rightbottom_pixel, keypointsUVD, validIndex, num_frames):
...
test_image_datasets = my_dataloader(testingImageDir, center_test, test_lefttop_pixel, 
                                    test_rightbottom_pixel, keypointsUVD_test, validIndex_test, TestImgFrames)
...
def main():   
    ...
    # print("The keypointsUVD_test:")
    # print(np.shape(keypointsUVD_test))
